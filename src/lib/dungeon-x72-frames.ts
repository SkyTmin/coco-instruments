// Координаты кадров атласа 16x16 DungeonTileset II v1.7 (0x72, CC0) — из
// файла tile_list_v1.7 набора, без правок: имя кадра → [x, y, ширина, высота].
// Сам атлас — public/dungeon/x72/atlas.png, авторство — CREDITS.txt рядом.

export const X72_FRAMES = {
...
export type X72Name = keyof typeof X72_FRAMES;
