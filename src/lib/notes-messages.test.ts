...
const img = { id: 'a1', name: 'p.jpg', type: 'image/jpeg', size: 10, url: '/uploads/p.jpg', createdAt: 0 };

describe('notes messages', () => {
  it('migrates a legacy body + attachments into one message (image tokens stripped)', () => {
    const msgs = materializeMessages({ body: 'Привет #тег\n\n![p](/uploads/p.jpg)', attachments: [img], createdAt: 5 });
