...
const SHAPES_2D: ShapeDef[] = [
  {
    ...
    results: [
      ...
      },
      {
        ...
        label: 'Периметр',
        formula: 'P = 4·a',
        hint: 'Сумма всех четырёх сторон.',
        dim: 'length',
        compute: (v) => 4 * v.a,
      },
      {
        ...
        label: 'Диагональ',
        formula: 'd = a·√2',
        hint: 'Линия между противоположными углами.',
        dim: 'length',
        compute: (v) => v.a * Math.SQRT2,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    validate: (v) =>
      v.a + v.b > v.c && v.a + v.c > v.b && v.b + v.c > v.a
        ? null
        : 'Такие стороны не образуют треугольник.',
    results: [
      {
        key: 'P',
        label: 'Периметр',
  ...
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        label: 'Высота',
        formula: 'h = √(a² − (b/2)²)',
        hint: 'Высота к основанию b.',
        dim: 'length',
        compute: (v) => Math.sqrt(v.a ** 2 - (v.b / 2) ** 2),
      },
      {
        key: 'A',
        label: 'Площадь',
        formula: 'A = (b/4)·√(4·a² − b²)',
        hint: 'Половина основания на высоту.',
        dim: 'area',
        compute: (v) => (v.b / 4) * Math.sqrt(4 * v.a ** 2 - v.b ** 2),
      },
    ],
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        label: 'Высота',
        formula: 'h = (√3/2)·a',
        hint: 'Высота к любой стороне.',
        dim: 'length',
        compute: (v) => (Math.sqrt(3) / 2) * v.a,
      },
      {
        key: 'A',
        label: 'Площадь',
        formula: 'A = (√3/4)·a²',
        hint: 'Площадь через сторону.',
        dim: 'area',
        compute: (v) => (Math.sqrt(3) / 4) * v.a ** 2,
      },
    ],
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        hint: 'Высота к основанию b.',
        dim: 'length',
        compute: (v) => v.a * Math.sin(rad(v.th)),
      },
      {
        key: 'A',
        label: 'Площадь',
        formula: 'A = a·b·sin θ',
        hint: 'Основание на высоту.',
        dim: 'area',
        compute: (v) => v.a * v.b * Math.sin(rad(v.th)),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Площадь',
        formula: 'A = ½·(a + b)·h',
        hint: 'Полусумма оснований на высоту.',
        dim: 'area',
        compute: (v) => ((v.a + v.b) / 2) * v.h,
      },
      {
        key: 'm',
        label: 'Средняя линия',
        formula: 'm = (a + b)/2',
        hint: 'Линия посередине между основаниями.',
        dim: 'length',
        compute: (v) => (v.a + v.b) / 2,
      },
    ],
    ...
    results: [
      {
        ...
        label: 'Высота',
        formula: 'h = √(c² − ((b−a)/2)²)',
        hint: 'Высота между основаниями.',
        dim: 'length',
        compute: (v) => Math.sqrt(v.c ** 2 - ((v.b - v.a) / 2) ** 2),
      },
      {
        key: 'P',
        label: 'Периметр',
      ...
      },
      {
        ...
        hint: 'Полусумма оснований на высоту.',
        dim: 'area',
        compute: (v) => ((v.a + v.b) / 2) * Math.sqrt(v.c ** 2 - ((v.b - v.a) / 2) ** 2),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Площадь',
        formula: 'A = ½·d₁·d₂',
        hint: 'Половина произведения диагоналей.',
        dim: 'area',
        compute: (v) => (v.d1 * v.d2) / 2,
      },
      {
        key: 'P',
        label: 'Периметр',
    ...
    results: [
      {
        ...
        label: 'Площадь',
        formula: 'A = π·r₁·r₂',
        hint: 'Произведение полуосей на π.',
        dim: 'area',
        compute: (v) => PI * v.r1 * v.r2,
      },
      {
        key: 'P',
        label: 'Периметр (прибл.)',
        formula: 'P ≈ 2·π·√((r₁² + r₂²)/2)',
        hint: 'Приближённая длина эллипса.',
        dim: 'length',
        compute: (v) => 2 * PI * Math.sqrt((v.r1 ** 2 + v.r2 ** 2) / 2),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Площадь',
        formula: 'A = π·(R² − r²)',
        hint: 'Площадь большого круга минус малого.',
        dim: 'area',
        compute: (v) => PI * (v.R ** 2 - v.r ** 2),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Площадь',
        formula: 'A = π·r²·(θ/360)',
        hint: 'Доля площади круга.',
        dim: 'area',
        compute: (v) => PI * v.r ** 2 * (v.th / 360),
      },
      {
        key: 'L',
        label: 'Длина дуги',
        formula: 'L = 2·π·r·(θ/360)',
        hint: 'Дуга сектора.',
        dim: 'length',
        compute: (v) => 2 * PI * v.r * (v.th / 360),
      },
      {
        key: 'P',
        label: 'Периметр',
        formula: 'P = L + 2·r',
        hint: 'Дуга плюс два радиуса.',
        dim: 'length',
        compute: (v) => 2 * PI * v.r * (v.th / 360) + 2 * v.r,
      },
    ],
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        label: 'Сторона',
        formula: 'a = ½·√(d₁² + d₂²)',
        hint: 'Через половины диагоналей.',
        dim: 'length',
        compute: (v) => Math.hypot(v.d1, v.d2) / 2,
      },
      {
        key: 'P',
        label: 'Периметр',
        ...
        hint: 'Сумма сторон.',
        dim: 'length',
        compute: (v) => 2 * Math.hypot(v.d1, v.d2),
      },
    ],
  },
  {
    ...
    validate: (v) =>
      Number.isInteger(v.n) && v.n >= 3 ? null : 'Число сторон — целое и не меньше 3.',
    results: [
      {
        key: 'P',
        label: 'Периметр',
        formula: 'P = n·s',
        hint: 'Все стороны равны.',
        dim: 'length',
        compute: (v) => v.n * v.s,
      },
      {
        key: 'A',
        label: 'Площадь',
        formula: 'A = n·s² / (4·tan(180°/n))',
        hint: 'Площадь правильного n-угольника.',
        dim: 'area',
        compute: (v) => (v.n * v.s ** 2) / (4 * Math.tan(PI / v.n)),
      },
      {
        key: 'ang',
        label: 'Внутренний угол',
        formula: '(n − 2)·180° / n',
        hint: 'Угол при каждой вершине.',
        dim: 'angle',
        compute: (v) => ((v.n - 2) * 180) / v.n,
      },
    ],
  },
];
...
const SHAPES_3D: ShapeDef[] = [
  {
    ...
    results: [
      ...
      },
      {
        ...
        label: 'Диагональ',
        formula: 'd = a·√3',
        hint: 'Пространственная диагональ.',
        dim: 'length',
        compute: (v) => v.a * Math.sqrt(3),
      },
    ],
  },
  {
    ...
    results: [
      ...
      },
      {
        key: 'A',
        label: 'Площадь поверхности',
        formula: 'A = 2·(a·b + b·c + c·a)',
        hint: 'Сумма шести граней.',
        dim: 'area',
        compute: (v) => 2 * (v.a * v.b + v.b * v.c + v.c * v.a),
      },
      {
        key: 'd',
        label: 'Диагональ',
        ...
        hint: 'Пространственная диагональ.',
        dim: 'length',
        compute: (v) => Math.sqrt(v.a ** 2 + v.b ** 2 + v.c ** 2),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = ⅓·π·r²·h',
        hint: 'Треть от цилиндра.',
        dim: 'volume',
        compute: (v) => (PI * v.r ** 2 * v.h) / 3,
      },
      {
        key: 'l',
        label: 'Образующая',
        formula: 'l = √(r² + h²)',
        hint: 'Боковая сторона (наклонная).',
        dim: 'length',
        compute: (v) => Math.hypot(v.r, v.h),
      },
      {
        key: 'A',
        label: 'Площадь поверхности',
        formula: 'A = π·r·l + π·r²',
        hint: 'Боковая плюс основание.',
        dim: 'area',
        compute: (v) => PI * v.r * Math.hypot(v.r, v.h) + PI * v.r ** 2,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = π·r²·h',
        hint: 'Площадь основания на высоту.',
        dim: 'volume',
        compute: (v) => PI * v.r ** 2 * v.h,
      },
      {
        key: 'A',
        label: 'Площадь поверхности',
        formula: 'A = 2·π·r·h + 2·π·r²',
        hint: 'Боковая плюс два основания.',
        dim: 'area',
        compute: (v) => 2 * PI * v.r * v.h + 2 * PI * v.r ** 2,
      },
      {
        key: 'S',
        label: 'Боковая поверхность',
        formula: 'S = 2·π·r·h',
        hint: 'Только боковая стенка.',
        dim: 'area',
        compute: (v) => 2 * PI * v.r * v.h,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        hint: 'Произведение полуосей.',
        dim: 'volume',
        compute: (v) => (4 / 3) * PI * v.a * v.b * v.c,
      },
    ],
  },
  {
    ...
    results: [
      {
        key: 'V',
        label: 'Объём',
        formula: 'V = π·h·(2·D² + d²) / 12',
        hint: 'Приближённый объём бочки.',
        dim: 'volume',
        compute: (v) => (PI * v.h * (2 * v.D ** 2 + v.d ** 2)) / 12,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = π·h·(R² − r²)',
        hint: 'Объём стенки трубы.',
        dim: 'volume',
        compute: (v) => PI * v.h * (v.R ** 2 - v.r ** 2),
      },
      {
        key: 'L',
        label: 'Боковая поверхность',
        formula: 'L = 2·π·h·(R + r)',
        hint: 'Внешняя плюс внутренняя стенки.',
        dim: 'area',
        compute: (v) => 2 * PI * v.h * (v.R + v.r),
      },
      {
        key: 'S',
        label: 'Полная поверхность',
        formula: 'S = L + 2·π·(R² − r²)',
        hint: 'Стенки плюс два кольца-торца.',
        dim: 'area',
        compute: (v) => 2 * PI * v.h * (v.R + v.r) + 2 * PI * (v.R ** 2 - v.r ** 2),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        hint: 'Объём усечённого конуса.',
        dim: 'volume',
        compute: (v) => (PI * v.h * (v.R ** 2 + v.R * v.r + v.r ** 2)) / 3,
      },
      {
        key: 'l',
        label: 'Образующая',
        formula: 'l = √((R − r)² + h²)',
        hint: 'Наклонная боковая сторона.',
        dim: 'length',
        compute: (v) => Math.hypot(v.R - v.r, v.h),
      },
      {
        key: 'A',
        label: 'Площадь поверхности',
        formula: 'A = π·(R + r)·l + π·R² + π·r²',
        hint: 'Боковая плюс оба основания.',
        dim: 'area',
        compute: (v) =>
          PI * (v.R + v.r) * Math.hypot(v.R - v.r, v.h) + PI * v.R ** 2 + PI * v.r ** 2,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        hint: 'Объём усечённой пирамиды.',
        dim: 'volume',
        compute: (v) => (v.h / 3) * (v.a ** 2 + v.a * v.b + v.b ** 2),
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = ⅓·l·w·h',
        hint: 'Треть от коробки.',
        dim: 'volume',
        compute: (v) => (v.l * v.w * v.h) / 3,
      },
      {
        key: 'Sb',
        label: 'Площадь основания',
        formula: 'S = l·w',
        hint: 'Прямоугольное основание.',
        dim: 'area',
        compute: (v) => v.l * v.w,
      },
    ],
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = ⅓·(½·a·h₀)·h',
        hint: 'Треть площади основания на высоту.',
        dim: 'volume',
        compute: (v) => (((v.a * v.hb) / 2) * v.h) / 3,
      },
    ],
  },
  {
    ...
    results: [
      {
        key: 'V',
        label: 'Объём',
        formula: 'V = ⅓·(5·s² / (4·tan 36°))·h',
        hint: 'Треть площади пятиугольника на высоту.',
        dim: 'volume',
        compute: (v) => (((5 * v.s ** 2) / (4 * Math.tan(PI / 5))) * v.h) / 3,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = (√3/2)·s²·h',
        hint: 'Треть площади шестиугольника на высоту.',
        dim: 'volume',
        compute: (v) => (Math.sqrt(3) / 2) * v.s ** 2 * v.h,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = ⅔·π·r²·h',
        hint: 'Объём шарового сектора.',
        dim: 'volume',
        compute: (v) => (2 / 3) * PI * v.r ** 2 * v.h,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Объём',
        formula: 'V = ½·b·h·L',
        hint: 'Площадь торца на длину.',
        dim: 'volume',
        compute: (v) => (v.b * v.h * v.L) / 2,
      },
    ],
  },
  {
    ...
    results: [
      {
        ...
        label: 'Площадь поверхности',
        formula: 'A = 4·π²·R·r',
        hint: 'Поверхность тора.',
        dim: 'area',
        compute: (v) => 4 * PI ** 2 * v.R * v.r,
      },
      {
        key: 'V',
        label: 'Объём',
