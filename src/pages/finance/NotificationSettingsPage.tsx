    ...
    <Screen title="Напоминания" subtitle="Уведомления о платежах">
      ...
      <div className="card" style={{ marginTop: 18 }}>
        <p className="muted" style={{ fontSize: 13, margin: 0, lineHeight: 1.5 }}>
          Уведомления приходят сообщением от <b>@coco_instruments_bot</b> в выбранное время по вашему
          часовому поясу. Работает, только если вы хотя бы раз открывали бота. Включить или выключить
          напоминание для конкретного платежа можно галочкой при его создании.
        </p>
      </div>
    </Screen>
  );
