...
const DIAGRAMS: Record<string, ReactElement> = {
  ...
  square: (
    <>
      ...
      <text x={140} y={66} textAnchor="middle">
        d
      </text>
    </>
  ),
  rectangle: (
    <>
      ...
      <text x={198} y={80} textAnchor="middle">
        b
      </text>
  ...
  triangle: (
    <>
      ...
      <text x={109} y={144} textAnchor="middle">
        b
      </text>
      <text x={168} y={74} textAnchor="middle">
        a
      </text>
      <text x={62} y={74} textAnchor="middle">
        c
      </text>
    </>
  ),
  isosceles: (
    <>
      ...
      <text x={160} y={76} textAnchor="middle">
        a
      </text>
      <text x={122} y={92} textAnchor="middle">
        h
      </text>
    </>
  ),
  equilateral: (
    <>
      ...
      <text x={62} y={78} textAnchor="middle">
        a
      </text>
      <text x={158} y={78} textAnchor="middle">
        a
      </text>
    </>
  ),
  parallelogram: (
    <>
      ...
      <text x={178} y={86} textAnchor="middle">
        a
      </text>
      <text x={80} y={86} textAnchor="middle">
        h
      </text>
      <text x={52} y={118} textAnchor="middle">
        θ
      </text>
    </>
  ),
  trapezoid: (
    <>
      ...
      <text x={110} y={31} textAnchor="middle">
        a
      </text>
      <text x={110} y={142} textAnchor="middle">
        b
      </text>
      <text x={122} y={86} textAnchor="middle">
        h
      </text>
    </>
  ),
  isotrapezoid: (
    <>
      ...
      <text x={172} y={84} textAnchor="middle">
        c
      </text>
      <text x={122} y={86} textAnchor="middle">
        h
  ...
  kite: (
    <>
      ...
      <text x={152} y={114} textAnchor="middle">
        b
      </text>
      <text x={120} y={120} textAnchor="middle">
        d₁
      </text>
      <text x={88} y={70} textAnchor="middle">
        d₂
      </text>
    </>
  ),
  circle: (
    <>
      ...
      <text x={138} y={71} textAnchor="middle">
        r
      </text>
    </>
  ),
  ellipse: (
    <>
      ...
      <circle cx={110} cy={80} r={2.5} className="dot" />
      <text x={150} y={71} textAnchor="middle">
        r₁
      </text>
      <text x={123} y={56} textAnchor="middle">
        r₂
      </text>
    </>
  ),
  annulus: (
    <>
      <path
        className="body"
        fillRule="evenodd"
        d="M110 80 m-60 0 a60 60 0 1 0 120 0 a60 60 0 1 0 -120 0 Z M110 80 m-32 0 a32 32 0 1 1 64 0 a32 32 0 1 1 -64 0 Z"
      />
      <path className="ln" d="M110 80 L170 80" />
      <path className="ln" d="M110 80 L110 48" />
      <text x={152} y={72} textAnchor="middle">
        R
      </text>
      <text x={122} y={64} textAnchor="middle">
        r
      </text>
    </>
  ),
  sector: (
    <>
      ...
      <text x={108} y={138} textAnchor="middle">
        r
      </text>
      <text x={95} y={112} textAnchor="middle">
        θ
      </text>
    </>
  ),
  rhombus: (
    <>
      ...
      <text x={122} y={110} textAnchor="middle">
        d₁
      </text>
      <text x={78} y={72} textAnchor="middle">
        d₂
      </text>
    </>
  ),
  ...
  cube: (
    <>
      ...
      <text x={88} y={152} textAnchor="middle">
        a
      </text>
    </>
  ),
  cuboid: (
    <>
      ...
      <text x={96} y={150} textAnchor="middle">
        a
      </text>
      <text x={174} y={94} textAnchor="middle">
        c
      </text>
  ...
  cone: (
    <>
      ...
      <text x={150} y={74} textAnchor="middle">
        l
      </text>
    </>
  ),
  cylinder: (
    <>
      ...
      <text x={142} y={36} textAnchor="middle">
        r
      </text>
      <text x={60} y={88} textAnchor="middle">
        h
      </text>
    </>
  ),
  sphere: (
    <>
      ...
      <circle cx={110} cy={80} r={2.5} className="dot" />
      <text x={140} y={72} textAnchor="middle">
        r
      </text>
    </>
  ),
  ellipsoid: (
    <>
      ...
      <path className="ln" d="M110 80 V34" />
      <text x={158} y={72} textAnchor="middle">
        a
      </text>
      <text x={122} y={54} textAnchor="middle">
        b
      </text>
      <text x={128} y={104} textAnchor="middle">
        c
      </text>
    </>
  ),
  barrel: (
    <>
      <path
        className="ln"
        d="M64 40 A70 16 0 0 0 156 40 M64 40 C44 70 44 90 64 120 A70 16 0 0 0 156 120 C176 90 176 70 156 40"
      />
      ...
      <text x={110} y={33} textAnchor="middle">
        d
      </text>
      <text x={30} y={82} textAnchor="middle">
        h
      </text>
  ...
  'hollow-cylinder': (
    <>
      ...
      <text x={150} y={38} textAnchor="middle">
        R
      </text>
      <text x={126} y={62} textAnchor="middle">
        r
      </text>
  ...
  'cone-frustum': (
    <>
      ...
      <text x={128} y={34} textAnchor="middle">
        r
      </text>
  ...
  'pyramid-frustum': (
    <>
      ...
      <text x={115} y={142} textAnchor="middle">
        a
      </text>
      <text x={115} y={33} textAnchor="middle">
        b
      </text>
      <text x={126} y={92} textAnchor="middle">
        h
      </text>
    </>
  ),
  ...
  pyramid: (
    <>
      ...
      <text x={166} y={140} textAnchor="middle">
        w
      </text>
      <text x={132} y={84} textAnchor="middle">
        h
      </text>
    </>
  ),
  'triangular-pyramid': (
    <>
      ...
      <text x={108} y={144} textAnchor="middle">
        a
      </text>
      <text x={128} y={82} textAnchor="middle">
        h
      </text>
    </>
  ),
  'pentagonal-pyramid': (
    <>
      ...
      <text x={64} y={140} textAnchor="middle">
        s
      </text>
      <text x={130} y={84} textAnchor="middle">
        h
      </text>
    </>
  ),
  'hexagonal-pyramid': (
    <>
      ...
      <text x={114} y={154} textAnchor="middle">
        s
      </text>
      <text x={128} y={78} textAnchor="middle">
        h
      </text>
    </>
  ),
  'spherical-sector': (
    <>
      ...
      <text x={122} y={56} textAnchor="middle">
        r
      </text>
  ...
  'triangular-prism': (
    <>
      ...
      <text x={66} y={92} textAnchor="middle">
        h
      </text>
      <text x={84} y={144} textAnchor="middle">
        b
      </text>
      <text x={170} y={112} textAnchor="middle">
        L
      </text>
    </>
  ),
