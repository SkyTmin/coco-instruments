...
export interface SlotsBlob {
  ...
  skin?: string;
  /**
   * Лимитированные скины, забранные игроком, пока их окно было открыто.
   * Отсюда и правило «взял — твоё навсегда»: список только растёт, и
   * календарь у него ничего не отнимает.
   */
  skinsOwned?: string[];
