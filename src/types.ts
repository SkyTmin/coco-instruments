...
export interface SlotsBlob {
  ...
  skin?: string;
  /**
   * Лучший множитель выигрыша за всё время, в ставках (не в монетах!).
   * Именно он открывает «Реликвию»: в монетах «лучший спин» зависит от
   * ставки и ничего не говорит о том, что игрок видел.
   */
  topX?: number;
